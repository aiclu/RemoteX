...
namespace _1RM.View.Editor
{
    ...
    public partial class PasswordPopupDialogView : WindowChromeBase
    {
        ...
        private void ButtonOpenPrivateKey_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                var path = SelectFileHelper.OpenFile(filter: "Private key|*.*", currentDirectoryForShowingRelativePath: Environment.CurrentDirectory, selectedFileName: vm.PrivateKey);
                if (path == null) return;
                vm.PrivateKey = path;
            }
        }
